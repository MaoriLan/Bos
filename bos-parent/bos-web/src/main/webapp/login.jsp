...
<script type="text/javascript">
	...
	function submit(){
		var username=document.getElementById('loginform:idInput').value;
		var password=document.getElementById('loginform:pwdInput').value;
		var checkcode=document.getElementById('loginform:codeInput').value;
...
<body>
	...
	<div
		style="width: 900px; height: 60px; position: absolute; text-align: left; left: 50%; top: 50%; margin-left: -450px;; margin-top: -280px;">
				...
				<form id="loginform" name="loginform" method="post" class="niceform"
					...
					<div id="idInputLine" class="loginFormIpt showPlaceholder"
						...
						<input id="loginform:idInput" type="text" name="username"
							class="loginFormTdIpt" maxlength="50"  value="<s:property value="#username"/>"/>
					...
					<div class="loginFormIpt loginFormIptWiotTh"
						...
						<a  onclick="submit();" id="loginform:j_id19" name="loginform:j_id19">
						<span
