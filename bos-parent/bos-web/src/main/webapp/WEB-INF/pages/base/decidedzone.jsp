...
<script type="text/javascript">
	...
	function doAssociations(){
		...
		if(rows.length!=1){
			...
			var url_2="${pageContext.request.contextPath}/DecidedZoneAction_findListNotAssociation.action";
			var url_1="${pageContext.request.contextPath}/DecidedZoneAction_findListHasAssociation.action";
	...
	function doDblClickRow(){
		...
		$('#association_subarea').datagrid( {
			...
			rownumbers : true,
			striped : true,
			url : "SubareaAction_associationDecidedzone.action?id="+rows[0].id,
			columns : [ [{
				field : 'id',
				title : '分拣编号',
				width : 120,
		...
		$('#association_customer').datagrid( {
			...
			rownumbers : true,
			striped : true,
			url : "DecidedZoneAction_associationCustomer.action?id="+rows[0].id,
			columns : [[{
				field : 'id',
				title : '客户编号',
				width : 120,
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div region="south" border="false" split=true  style="height:150px">
					...
					<tr>
						...
						<td>
							<input class="easyui-combobox" name="staff.id"  
    							data-options="valueField:'id',textField:'name',url:'StaffAction_staffAjax.action'" />  
						</td>
					</tr>
					<tr height="300">
	...
	<div  modal= true class="easyui-window" title="关联客户窗口" id="customerWindow" collapsible="false" closed="true" minimizable="false" maximizable="false" style="top:20px;left:200px;width: 400px;height: 300px;">
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="customerForm" action="${pageContext.request.contextPath }/DecidedZoneAction_AssosociationDecidedzone.action" method="post">
				<table class="table-edit" width="80%" align="center">
					<tr class="title">
