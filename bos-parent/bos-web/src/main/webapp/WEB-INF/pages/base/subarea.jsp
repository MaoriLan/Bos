...
<script type="text/javascript">
	...
	function doExport(){
		window.location="SubareaAction_exportXLS.action"
	}
	...
	function showHighcharts(){
		...
		$.post('SubareaAction_showHighcharts.action',function(data){
			$('#test').highcharts({
	 	        chart: {
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="分区添加修改" id="addSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="addSubareaForm" action="${pageContext.request.contextPath}/SubareaAction_addSubarea.action" method="post">
					...
					<tr>
						...
						<td>
							<input class="easyui-combobox" name="region.id"  
    							...
    							url:'${pageContext.request.contextPath}/RegionAction_loadRegion'" />  
						</td>
					</tr>
					<tr>
						<td>关键字</td>
	...
	<!-- 查看区域分区分布图 -->
	<div class="easyui-window" title="查看区域分区分布图" id="showSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		<div split="false" border="false" >
			<div id="test"></div>
		</div>
	</div>
