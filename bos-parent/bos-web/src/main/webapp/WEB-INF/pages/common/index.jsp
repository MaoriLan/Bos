...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#btnEp").click(function(){
			var flag=$("#editPassword").form("validate");
			if(flag){
				var newPass=$("#txtNewPass").val();
				var txtRePass=$("#txtRePass").val();
				if(newPass==txtRePass){
					$.post("${pageContext.request.contextPath}/UserAction_editPassword.action", { password: txtRePass},
							  function(data){
							   if(data=="1"){
								   $('#editPwdWindow').window('close');
								   $.messager.alert('提示信息','修改密码成功','info');
							   }else{
								   $.messager.alert('错误','修改密码错误','error'); 
							   }
							  },"json");
				}else{
...
<body class="easyui-layout">
	<div data-options="region:'north',border:false"
		style="height:80px;padding:10px;background:url('./images/header_bg.png') no-repeat right w;">
